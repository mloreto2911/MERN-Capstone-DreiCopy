    ...
    <div className="bg-shade py-5">
      <div className="bg-light mx-20 my-20 rounded-xl">
        <div className="pt-20 text-center">
          <h2 className=" text-primary text-4xl font-semibold ">Build Your Profile</h2>
        </div>
          ...
          <form action="">
            ...
            <div className="container grid gap-5 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <div className="flex flex-col mb-5">
                ...
                <select
                  ...
                  className="w-full lg:w-56 xl:w-80 px-3 py-2 border  border-gray-300 rounded-md focus:outline-none focus:ring-primary focus:border-primary"
                >
                <option disabled value="Choose Gender">Choose Gender</option>
            ...
            <div className="container grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
              ...
              <select
                ...
                className="w-full  lg:w-56 xl:w-80 px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-primary focus:border-primary"
              >
                <option disabled value="ID Type (e.g TIN)">ID Type (e.g TIN)</option>
            ...
            <div className="flex flex-col sm:mt-12 md:mt-6">
              ...
              />
              {idNumberError && !validIDSubmitted && <p className="text-red-500">{idNumberError}</p>}
            </div>
            </div>
              ...
              <div className="pt-10">
                <div
                  className={`border ${validIdPhoto ? 'border-none' : 'border-primary'}`}
                ...
                >
                  <div className="flex flex-col justify-center items-center">
                    ...
                    <input type="file" accept="image/*" onChange={handleFileUpload} value={fileInputValue} className='my-5 mx-3' />
                    {fileSizeError && <p className="text-red-600">File size exceeds the maximum limit of 1MB.</p>}
                    {fileImageError && <p className="text-red-600">File is not an image </p>}
